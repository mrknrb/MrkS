                    ...
                    db7
                        ...
                        .then(function (mentwin) {
                            if (eszkoz != "android") {
                                ...
                                self.aktivwindowid = parseInt(params.target.value);
                                self.kategoriaszuro = mentwin.docs[0].kategoria;
                                self.alkategoriaszuro = mentwin.docs[0].alkategoria;
                                self.alalkategoriaszuro = mentwin.docs[0].alalkategoria;
